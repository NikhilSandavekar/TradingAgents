...
_ENV_OVERRIDES = {
    ...
    "TRADINGAGENTS_STRATEGY_MODE": "strategy_mode",
    "TRADINGAGENTS_SWING_MIN_HOLD_DAYS": "swing_min_hold_days",
    "TRADINGAGENTS_SWING_MAX_HOLD_DAYS": "swing_max_hold_days",
    "TRADINGAGENTS_MIN_REWARD_RISK": "min_reward_risk",
    "TRADINGAGENTS_MAX_ACCOUNT_RISK_PCT": "max_account_risk_pct",
    "TRADINGAGENTS_EVALUATION_HORIZON_DAYS": "evaluation_horizon_days",
...
DEFAULT_CONFIG = _apply_env_overrides(
    {
        ...
        # Optional trading-strategy mandate. "general" preserves the upstream
        # behavior; "swing" injects a bounded holding horizon and risk rules into
        # every agent prompt. Percent values are percentages of account equity.
        "strategy_mode": "general",
        "swing_min_hold_days": 2,
        "swing_max_hold_days": 15,
        "min_reward_risk": 2.0,
        "max_account_risk_pct": 0.5,
        # Realized-return window used by the decision-log reflection layer.
